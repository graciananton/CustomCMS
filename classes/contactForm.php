    ...
    public function viewForm(){
        if($this->request['lang']=="tamil"){
            ...
            <div id='contactForm' style='width:60%;'>
                <form id='contact_form'  action='https://gracian.ca/churchofgrace/index.php?pid=400&lang=tamil' method='get' enctype='multipart/form-data'>
                ...
                <div class='row' style='margin-top:15px;margin-bottom:15px;'>
                    ...
                    <input id='hidden' type='hidden' name='lang' value='tamil'/>
        ...
        $this->contactForm = "
            <div style='padding-left:10px;padding-bottom:7px;'>Thank you for visiting our website. We're here to support you and answer any questions you might have. Whether you're new, looking for spiritual guidance, wanting help reaching our church, prayer requests, or just want to learn more about us, we’d love to hear from you. Please use the form below to ask any questions or give us a call at 613-762-2174.</div>
            <div id='contactForm' style='width:60%;'>
                <form id='contact_form'  action='https://gracian.ca/churchofgrace/index.php' method='get' enctype='multipart/form-data'>
                <div class='row' style='width:95%;'>
                    <label class='required' for='name' id='name'>Your name:</label><br />
                    <input id='name' class='input' name='name' type='text' value=''><br />
                    <span id='name_validation' class='error_message'></span>
                </div>
                <div class='row' style='width:95%;'>
                    <label class='required' for='email' id='email'>Your email address:</label><br/>
                    <input id='email' class='input' name='email' type='text' value=''><br/>
                    <span id='email_validation' class='error_message'></span>
                </div>
                <div class='row' style='width:95%;'>
                    <label class='required' for='message' id='message'>Your message:</label><br/>
                    <textarea id='message' class='input' name='message'   rows='7' cols='1'></textarea><br/>
                    <span id='message_validation' class='error_message'></span>
                </div>
                <div class='row' style='margin-top:15px;margin-bottom:15px;'>
                    ...
                    <input id='submit' type='submit' value='Send email' style='background-color:#C41E3A; color:white; border:none; padding:10px 20px; border-radius:5px; cursor:pointer; font-size:16px;'/>
                    <input id='hidden' type='hidden' name='pid' value='400'/>
                    <input id='hidden' type='hidden' name='lang' value='english'/>
                </form>
              </div>
              <div id='prayerRequest' style='width:40%;'>
                  <div id='prayerPrompt' style='margin-left:5%;font-size:20px;color:#C41E3A;'><b>Prayer Requests</b></div>
                  <font class='pr_name'>
                  <p><font class='pr_name'><font class='pr_name'><strong>Matthew 18:19:<br></strong></font>Again I say to you, that if two of you agree on earth about anything that they may ask, it shall be done for them by My Father who is in heaven. </font></p>



                  <font class='pr_name'>
                  <p><font class='pr_name'><font class='pr_name'><strong>Matthew 21:22: <br></strong></font>  If you believe, you will receive whatever you ask for in prayer. </font></p>


                  <font class='pr_name'>
                  <p><font class='pr_name'><font class='pr_name'><strong>Mark 9:23: <br></strong></font> Everything is possible for him who believes. </font></p>


                  <font class='pr_name'>
                  <p><font class='pr_name'><font class='pr_name'><strong>I John 5: 14-15: <br></strong></font>This is the confidence we have in approaching God: that if we ask anything according to His will, He hears us.  And if we know that He hears us - whatever we ask - we know that we have what we asked of Him. </font></p>
                  </font>
                </div>
            ";
         }
        ...
        if($this->request['lang']=="tamil"){
            $this->confirmationMessage = "
                <div class='thank-you' style='font-family: Arial, sans-serif;text-align: center;padding: 20px;margin: 20px auto;border: 1px solid #ccc;max-width: 400px;background-color: #f9f9f9;'>
                    <h2>நன்றி!</h2>
                    <p>உங்கள் படிவம் வெற்றிகரமாக சமர்ப்பிக்கப்பட்டது. அடுத்த ஒரு நாளில் பதிலளிக்க முயல்கிறோம்</p>
                </div>
            ";
            ...
            $this->confirmationMessage = "
                <div class='thank-you' style='font-family: Arial, sans-serif;text-align: center;padding: 20px;margin: 20px auto;border: 1px solid #ccc;max-width: 400px;background-color: #f9f9f9;'>
                <h2>Thank You!</h2>
                <p>Your form has been submitted successfully. We will try to respond within the next one day</p>
                </div>
            ";
        }
            ...
            $this->errorForm ="
                ...
                <div id='contactForm' style='width:60%;'>
                    ...
                    <div class='row' style='margin-top:15px;margin-bottom:15px;'>
                        ...
                        <input id='submit' type='submit' value='Send email' style='color:#C41E3A; background-color:#C41E3A;color:white; border:none; padding:10px 20px; border-radius:5px; cursor:pointer; font-size:16px;'/>
                        <input id='hidden' type='hidden' name='pid' value='400'/>
                    </form>
                  </div>
                  <div id='prayerRequest' style='width:40%;'>
