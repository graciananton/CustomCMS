...
class databaseManager{
    ...
    public function traverse_ip_addresses(){
        $this->connect();
        $sql = "SELECT ip_address,date_Inserted,pid FROM tamilip_addresses";
        $resultSet = array();
    ...
    private function insert_ip_address($server_name){
        ...
        $sql = "INSERT INTO tamilip_addresses(ip_address,date_Inserted) VALUES ('$server_name','$date')";
    ...
    public function findUploadedDates(){
        $this->connect();
        $selection = "SELECT uploadedDate,pid FROM tamilsermons";
    ...
    public function insertMedia($aMediaList){
        ...
        $sql = "INSERT INTO tamilsermons(title,uploadedDate,notes,webAddress,givenBy) VALUES('$title','$uploadedDate','$notes','$videoUrl','$givenBy')";
        $command = mysqli_query($this->con,$sql);
    }
    ...
    public function deleteMedia($aMediaList){
        $this->connect();
        $sql = "DELETE FROM tamilsermons WHERE pid=".$aMediaList['pid'];
        if($this->con->query($sql) === TRUE){
    ...
    public function findSermonPageInformationByPid($pid){
        $this->connect();
        $sql = "SELECT pid,title,uploadedDate, notes, webAddress,givenBy FROM tamilsermons WHERE pid =".$pid;
