...
Book We Are Covering: 2 Thessalonians
                    ...
                    <form enctype='multipart/form-data' action='' method='post' id='personForm'>
                        ...
                        ?>
                            ...
                            <div id="grid-item">
                                ...
                                <textarea id='searchKeywords' name="searchKeyword" rows="50" cols="250"><?php echo $searchKeyword;?></textarea>
                            </div>
                        <?php
                           }
                            if($pageType == "Config"){
        ...
        public function createTableBySearchResult($pageList){
            ...
            echo "<table border = '1px solid black'>";
            if(count($pageList)>0){
                echo "<tr><th>Title</th><th>Short Title:</th><th>Page Type</th><th>Page Id</th><th>Edit</th><th>Delete</th></tr>";
            ...
            for($i=0;$i<$size;$i++){
                $obj = $pageList[$i];
                if($obj){                      
                       echo sprintf($row,$obj->title,$obj->shortTitle,
        ...
        public function displayMediaPage($keyword,$list){
            ...
            if($keyword=="table"){
                $this->displaySearchForm("sermons");
                $list =$this->aDatabaseManager->findSermonResults();
                echo "<table border = '1px solid black'>";
                if(count($list)>0){
                    echo "<tr><th>Video URL:</th><th>Date Uploaded:</th><th>Sermon Notes</th><th>Given By:</th><th>Title</th><th>Edit</th><th>Delete</th></tr>";
                ...
                for($i=0;$i<$size;$i++){
                    $obj = $list[$i];                      
                        echo sprintf($row,$obj->webAddress,$obj->uploadedDate,$obj->notes,$obj->givenBy,$obj->title,$obj->pid,$obj->pid);
